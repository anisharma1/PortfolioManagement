...
CREATE TABLE `current_holdings` (
  ...
  `investment_in_stock` int NOT NULL,
...
--
-- Dumping data for table `current_holdings`
--

LOCK TABLES `current_holdings` WRITE;
/*!40000 ALTER TABLE `current_holdings` DISABLE KEYS */;
INSERT INTO `current_holdings` VALUES (1,1,40,12000,1),(2,1,20,8000,2),(3,2,80,32000,2);
/*!40000 ALTER TABLE `current_holdings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-03-20 14:28:43
